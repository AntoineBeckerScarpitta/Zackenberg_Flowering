...
plot(Value ~ Year , data=clim_day[clim_day$Site=="Nuuk" &
                                    clim_day$Variable=="Temperature_C", ], 
     ylab="Temperatures (°C)", pch=21, ylim=round(range(clim_day[clim_day$Variable=="Temperature_C", 
                                                  "Value"]), 0), 
...
plot(Value ~ Year , data=clim_month[clim_month$Site=="Nuuk" & 
                                    clim_month$Variable=="Temperature_C", ], 
     ylab="Temperatures (°C)", pch=21, ylim=round(range(clim_month[clim_month$Variable=="Temperature_C", 
                                                        "Value"]), 0), 
     cex=2, xaxt='n', xlab='', col="blue", bg="blue", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_year[clim_year$Site=="Nuuk" & 
                                   clim_year$Variable=="Temperature_C", ], 
     ylab="Temperatures (°C)", pch=21, ylim=round(range(clim_year[clim_year$Variable=="Temperature_C", 
                                                                   "Value"]), 0), 
...
plot(Value ~ Year , data=clim_day[clim_day$Site=="Nuuk" &
                                    clim_day$Variable=="Precipitation_mm", ], 
     ylab="Precipitation (mm)", pch=21, ylim=round(range(clim_day[clim_day$Variable=="Precipitation_mm", 
                                                                  "Value"]), 0), 
     cex=2, xaxt='n', xlab=' ', col="blue", bg="blue", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_day[clim_day$Site=="Zackenberg" & 
                                    clim_day$Variable=="Precipitation_mm", ], 
     ylab=" ", pch=21, ylim=round(range(clim_day[clim_day$Variable=="Precipitation_mm", 
                                                 "Value"]), 0), 
     cex=2, xaxt='n', xlab='', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_month[clim_month$Site=="Nuuk" & 
                                      clim_month$Variable=="Precipitation_mm", ], 
     ylab="Precipitation (mm)", pch=21, ylim=round(range(clim_month[clim_month$Variable=="Precipitation_mm", 
                                                                  "Value"]), 3),
     cex=2, xaxt='n',xlab='', col="blue", bg="blue", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_month[clim_month$Site=="Zackenberg" & 
                                      clim_month$Variable=="Precipitation_mm", ], 
     ylab=" ", pch=21, ylim=round(range(clim_month[clim_month$Variable=="Precipitation_mm", 
                                                   "Value"]), 3),
     cex=2, xaxt='n', xlab='', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_year[clim_year$Site=="Zackenberg" & 
                                     clim_year$Variable=="Precipitation_mm", ], 
     ylab=" ", pch=21, ylim=round(range(clim_year[clim_year$Variable=="Precipitation_mm", 
                                                  "Value"]), 3), 
     cex=2, xaxt='n', xlab='Year', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_day[clim_day$Site=="Zackenberg" & 
                                    clim_day$Variable=="Humidity_%", ], 
     ylab=" ", pch=21, ylim=round(range(clim_day[clim_day$Variable=="Humidity_%", 
                                                 "Value"]),0), 
     cex=2, xaxt='n', xlab='', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_month[clim_month$Site=="Zackenberg" & 
                                    clim_month$Variable=="Humidity_%", ], 
     ylab=" ", pch=21, ylim=round(range(clim_month[clim_month$Variable=="Humidity_%", 
                                                   "Value"]), 0), 
     cex=2, xaxt='n', xlab='', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_year[clim_year$Site=="Nuuk" & 
                                   clim_year$Variable=="Humidity_%", ], 
     ylab="Humidity (%)", pch=21, ylim=round(range(clim_year[clim_year$Variable=="Humidity_%", 
                                                              "Value"]), 0), 
     cex=2, xaxt='n', xlab='Year', col="blue", bg="blue", cex.axis=1.5, cex.lab=1.5, 
...
plot(Value ~ Year , data=clim_year[clim_year$Site=="Zackenberg" & 
                                   clim_year$Variable=="Humidity_%", ], 
     ylab=" ", pch=21, ylim=round(range(clim_year[clim_year$Variable=="Humidity_%", 
                                                  "Value"]), 0), 
     cex=2, xaxt='n', xlab='Year', col="red", bg="red", cex.axis=1.5, cex.lab=1.5, 
